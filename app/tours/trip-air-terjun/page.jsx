...
const TiuKelepTour = () => {
    ...
    const tourData = {
        title: 'Tour Air Terjun Tiu Kelep',
        description: 'Berada di Desa Senaru Kabupaten Lombok Utara tepat di bawah lereng gunung Rinjani, Tiu Kelep merupakan air terjun terindah yang paling banyak dikunjungi wisatawan. Air terjun Tiu Kelep merupakan tempat wisata favorit selain air terjun Sendang Gile yang juga memiliki keindahan kelas dunia. Airnya yang sangat jernih dan bersih menjadikan keduanya menjadi destinasi favorit para traveler maupun adventure yang menyukai panorama alam hutan yang hijau dan natural. Memiliki ketinggian hampir 50 meter, membuat airnya yang jatuh dari ketinggian seakan terbang ke segala arah, membuat suasananya terlihat mengagumkan. Tiu diartikan oleh masyarakat sekitar berarti kolam dan Kelep berarti terbang hingga membuat air terjun ini dinamakan Tiu Kelep.',
        details: {
        ...
        pricing: [
            { participants: '2 Orang', price: 'Rp 480.000 / pack' },
            { participants: '3-4 Orang', price: 'Rp 350.000 / pack' },
            { participants: '5-6 Orang', price: 'Rp 300.000 / pack' },
            { participants: '7-10 Orang', price: 'Rp 285.000 / pack' },
            { participants: '11-15 Orang', price: 'Rp 260.000 / pack' },
        ],
        included: [
            'Private transport',
        ...
        notes: [
            ...
            'Harga dihitung per pack / per orang',
